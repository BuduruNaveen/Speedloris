...
print("Note: This tool is made for educational purposes only....")
...
def main():
    ...
    while True:
        try:
            speedloris_iteration()
        except (KeyboardInterrupt, SystemExit):
            logging.info("Stopping Speedloris")
            break
        except Exception as e:
            logging.debug("Error in Speedloris iteration: %s", e)
